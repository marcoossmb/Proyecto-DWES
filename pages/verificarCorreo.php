                                ...
                                <table role='presentation' cellspacing='0' cellpadding='0' width='100%' style='margin: auto;'>
                                    <tr>
                                        <td style='max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);'>
                                            <h1 class='h1'>Estimado/a " . $nombre . "</h1>
                                            <p class='p'>Hemos recibido una solicitud para cambiar la contraseña asociada a su cuenta en la página web de tu equipo.</p>
                                            <p class='p'>Para garantizar la seguridad de su cuenta, necesitamos verificar que esta solicitud proviene legítimamente de usted.</p>
                                            <p class='p'>Por favor, haga clic en el siguiente enlace para confirmar su intención de cambiar la contraseña:</p>
                                            <p class='pboton'><a style='color: #ffffff; text-decoration: none; font-size: 16px; display: inline-block; padding: 10px 20px; background-color: #28a745; border-radius: 5px; text-align: center;' href='http://localhost/Proyecto-DWES/pages/cambiarcontra.php?verificarTrue&&nombre=" . urlencode($nombre_codificado) . "'>Verificar Correo</a></p>
                                            <p class='p'>Si no ha solicitado este cambio o no reconoce esta actividad, le recomendamos que ignore este mensaje y tome las medidas necesarias para asegurar su cuenta.</p>
                                        </td>
                                    </tr>
                                </table>
                            </body>
